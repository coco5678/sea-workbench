(function (global) {
  ...
  function tag(inner, size) {
    var s = size || 22;
    return '<svg class="pix stk" width="' + s + '" height="' + s + '" viewBox="0 0 24 24" fill="none" stroke="' + INK + '" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + inner + "</svg>";
  }
